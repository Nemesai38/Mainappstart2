...
# Heading
heading = CTkLabel(master=app, font=("Roboto", 18, "italic"), text="Personnel Information", text_color="#ba862c")
...
state_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="State:", text_color="#ba862c")
state_label.place(x=10, rely=.55)
per_state_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][8], text_color="#ba862c")
per_state_label.place(x=90, rely=.55)
unit_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Unit:", text_color="#ba862c")
unit_label.place(x=10, rely=.6)
per_unit_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][4], text_color="#ba862c")
per_unit_label.place(x=90, rely=.6)
corps_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Corps:", text_color="#ba862c")
corps_label.place(x=10, rely=.65)
per_corps_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][5], text_color="#ba862c")
per_corps_label.place(x=90, rely=.65)
deployment_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Deployment:", text_color="#ba862c")
deployment_label.place(x=10, rely=.7)
per_deployment_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][7], text_color="#ba862c")
per_deployment_label.place(x=150, rely=.7)
appointment_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Appointment:", text_color="#ba862c")
appointment_label.place(x=10, rely=.75)
per_appointment_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][6], text_color="#ba862c")
per_appointment_label.place(x=150, rely=.75)
trade_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Trade:", text_color="#ba862c")
trade_label.place(x=10, rely=.8)
per_trade_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][9], text_color="#ba862c")
per_trade_label.place(x=90, rely=.8)
marital_status_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Marital Status:", text_color="#ba862c")
marital_status_label.place(x=10, rely=.85)
per_marital_status_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][11], text_color="#ba862c")
per_marital_status_label.place(x=165, rely=.85)
address_label = CTkLabel(master=app, font=("Roboto", 18, "italic", "bold"), text="Accommodation:", text_color="#ba862c")
address_label.place(x=10, rely=.895)
per_address_label = CTkLabel(master=app, font=("Roboto", 18, "italic"), text=r[i][10],
